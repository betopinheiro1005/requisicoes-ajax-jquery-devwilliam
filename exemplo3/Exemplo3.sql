...
/* Tabela de Estados */
CREATE TABLE tab_uf (id INTEGER auto_increment NOT NULL, descricao CHARACTER VARYING(50), PRIMARY KEY (id));
...
/* Tabela de Cidades */
CREATE TABLE tab_cidade (id INTEGER auto_increment NOT NULL, descricao CHARACTER VARYING(50), id_uf BIGINT, PRIMARY KEY (id));
